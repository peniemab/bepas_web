...
export function SiteHeader() {
  return (
    <header className="sticky top-0 z-40 w-full border-b border-border bg-background/95 supports-backdrop-filter:backdrop-blur-sm">
      <div className="mx-auto flex min-h-16 max-w-7xl items-center gap-2 px-4 py-2 sm:px-6 md:h-16 md:gap-4 md:py-0 lg:px-8">
        <div className="flex w-12 shrink-0 items-center justify-start md:hidden">
          <MobileNav />
        </div>
